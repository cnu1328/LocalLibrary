...
console.log(
  ...
  async function authorCreate(index, first_name, surname, d_birth, d_death) {
    const authordetail = { first_name: first_name, surname: surname };
    ...
    console.log(`Added author: ${first_name} ${surname}`);
  }
